...
//Validaciones
import { validationDateWeb, validationString } from "../../../../utils/Validations";

const HorizontalCard = (props) => {

    const history = useHistory();
    const { typeUser, setIdVehiculo, infoAlqui, setInfoAlqui } = useContext(AuthContext);
                ...
                <Col xs={12} md={3} className="d-grid gap-2 p-5">
                    ...
                    <Button
                        onClick={() => {
                            ...
                            setInfoAlqui( {...infoAlqui, precio_neto: props.item.precio_dia } )
                            validacionInfoAlqui();
                        }}
                        style={{
                            backgroundColor: "#F7B569",
