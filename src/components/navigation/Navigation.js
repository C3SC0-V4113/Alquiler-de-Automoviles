...
const Navigation = () => {
    return(
        <NavigationContainer>
            <Drawer.Navigator screenOptions={{drawerStyle: { backgroundColor: '#1C2530',width: '100%',}, drawerActiveBackgroundColor:{backgroundColor:'white'} , drawerLabelStyle:{marginLeft:20,padding: 10 ,fontWeight: 'bold',color: 'white',fontSize: 30, textAlign: 'center', borderBottomColor: '#F7B661',borderBottomWidth: 5, borderTopColor: '#F7B661',borderTopWidth: 5, } ,headerStyle:{backgroundColor:'#9C784B'},headerTintColor:'white',headerTitleStyle:{fontWeight:'bold', fontSize: 25, textAlign: 'center'},}}>
                <Drawer.Screen name='Inicio' component={Saludo} />
                <Drawer.Screen name='Vehiculos' component={Saludo} />
